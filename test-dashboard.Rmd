...
<p style="text-align:center;">
  ![](www/up-arrow.png){width=30px}&nbsp;&nbsp;Use the navigation above to fly through the topics&nbsp;&nbsp;![](www/up-arrow.png){width=30px}
</p> 

###
<p style="text-align:center;">
  ![](www/up-arrow.png){width=30px}&nbsp;&nbsp;Select the first story entry to start your journey&nbsp;&nbsp;![](www/up-arrow.png){width=30px}
</p> 

###
<p style="text-align:center;">
  ![](www/up-arrow.png){width=30px}&nbsp;&nbsp;Play around with interactive plots and learn more&nbsp;&nbsp;![](www/up-arrow.png){width=30px}
</p> 
...
### 
Use this little dashboard to discover an alarming development of our natural environment: The decline of the honey bees.
...
-------------------------------------
### {.no-padding}
<h2>The Problem of the Honeybee</h2>
...
-------------------------------------
### {.no-padding}
<h2>Bees - Information beehind</h2>
...
-------------------------------------
### {.no-padding}
<h2>Where did all the honey go?</h2>
...
-------------------------------------
### {.no-padding}
<h2>Which states produce the most honey?</h2>
...
-------------------------------------
### {.no-padding}
<h2>A dramatic turn of... honey?</h2>
...
ggplot(data=pesticides_year_total,
                 aes(x = year, title = "Year 2000 - What happened to our honey?")
                 ) + 
...
Honey Price {data-navmenu="Interactive Plots"}
=====================================
...
Map {data-navmenu="Interactive Plots"}
=====================================


Health Status {data-navmenu="Story"}
=====================================

Row {data-height=60}
-------------------------------------
### {.no-padding}
<h2>Beehive unnatural: Ssssssomething wrong with the bees?</h2>
